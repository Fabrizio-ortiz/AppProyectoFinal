...
class PlatoFuerteMain : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val listaPlatos = listOf(
            PlatosFuertes("LOMO SALTADO", "Salteado con papas y arroz", 32.0, R.drawable.lomo_saltado),
            PlatosFuertes("AJÍ DE GALLINA", "Crema de ají amarillo con pollo y arroz", 25.0, R.drawable.aji_de_gallina),
            PlatosFuertes("SECO DE RES", "Con frejoles y arroz", 30.0, R.drawable.seco_de_res),
            PlatosFuertes("CEVICHE", "Jugo de limón con pescado", 25.0, R.drawable.ceviche),
            PlatosFuertes("TALLARÍN HUANCAINA C/LOMO", "", 49.0, R.drawable.tallarin_huancaina)
        )
